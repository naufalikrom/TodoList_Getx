...
class ReportPage extends StatelessWidget {
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  _buildStatatus(Colors.green, liveTasks, 'Live Tasks'),
                  _buildStatatus(
                      Colors.orange, completedTasks, 'Complated Tasks'),
                  _buildStatatus(Colors.blue, createdTasks, 'Created'),
                ],
              ),
            ),
            SizedBox(
              ...
              child: SizedBox(
                ...
                child: CircularStepProgressIndicator(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        '${createdTasks == 0 ? 0 : percent.toInt().toString()} %',
                        style: TextStyle(
  ...
  Row _buildStatatus(Color color, int number, String text) {
    return Row(
